...
Version  : 1.1.1
Release  : 3
URL      : https://cran.r-project.org/src/contrib/basefun_1.1-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/basefun_1.1-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636732765
