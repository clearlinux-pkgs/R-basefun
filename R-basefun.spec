...
Version  : 1.1.2
Release  : 6
URL      : https://cran.r-project.org/src/contrib/basefun_1.1-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/basefun_1.1-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642181458
